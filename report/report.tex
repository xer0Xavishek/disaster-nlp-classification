...
\author{
  ...
  Department of Computer Science and Engineering \\
  BRAC University, Dhaka, Bangladesh \\
  \texttt{sreema.roy@g.bracu.ac.bd} \\
  \texttt{Student ID: 23201444 \quad Section: 03}
  \AND
  Fahim Tasnim Khan \\
  Department of Computer Science and Engineering \\
  BRAC University, Dhaka, Bangladesh \\
  \texttt{fahim.tasnim.khan@g.bracu.ac.bd} \\
  \texttt{Student ID: 23201087 \quad Section: 03}
  \And
  Tawsif Kabir Pritom \\
  Department of Computer Science and Engineering \\
  BRAC University, Dhaka, Bangladesh \\
  \texttt{tawsif.kabir.pritom@g.bracu.ac.bd} \\
  \texttt{Student ID: 23201231 \quad Section: 03}
}
